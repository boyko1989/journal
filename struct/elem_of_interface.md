...
#### ***[Логотип](design_of_elem/logo_des.md)***
...
#### ***[Рекламный баннер](design_of_elem/advertising_banner_des.md)***

![](design_of_elem/img/banner-ad-1.webp)

#### ***[Счетчик посещаемости](design_of_elem/attendance_counterr_des.md)***
...
#### ***[Иконки](design_of_elem/icons_des.md)***
...
#### ***[Метка (label)](design_of_elem/label_des.md)***
...
#### ***[Новостной блок](design_of_elem/news_des.md)***
Новостной блок представляет собой ленту, в которой материалы размещены в хронологическом порядке.
...
![](https://borodaboroda.com/wp-content/uploads/knopka-3x.png)

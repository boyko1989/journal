...
#### ***[Stepper](design_of_elem/input_type_number_des.md)***
...
#### ***[Переключатель (switch)](design_of_elem/check_theory.md)***
Элемент интерфейса, который позволяет выбрать одно из состояний, чаще всего вкл/выкл.

![](https://borodaboroda.com/wp-content/uploads/switch-3x.png)

#### ***[Выпадающий список (Select)](design_of_elem/select_theory.md)***
...
***раскрывающийся список*** (combo box (комбинированный список, поле со списком), drop-down list) — этот элемент нельзя путать с select
...
#### ***[Прелоадер (Preloader)](design_of_elem/progress_elements.md)***
Анимированный элемент, воспроизводящийся в процессе загрузки сайта, видео, изображений и другого контента.
...
#### ***[Слайдер](design_of_elem/slider_theo.md)***
Переключатель изображений (или другого контента) работающий автоматически или вручную.
